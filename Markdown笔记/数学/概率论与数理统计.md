...
$X$ 的概率密度的图像如图 2.1 所示，分布函数的图像如图 2.2 所示.
...
$X$ 的概率密度的图像如图 2.3 所示，分布函数的图像如图 2.4 所示.
...
$X$ 的概率密度的图像如图 2.5 所示，分布函数的图像如图 2.6 所示.
...
$\varphi(x)$ 的图像如图 2.9 所示，$\varPhi(x)$ 的图像如图 2.10 所示.
